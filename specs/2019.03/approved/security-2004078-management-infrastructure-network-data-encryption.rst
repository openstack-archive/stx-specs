...
In some case, the user's product or system will sync up some sensitive data on
management or infrastructure network. To prevent secrete information, user will
prefer to make data encryption before data transferring.

To fulfill this task, enable IPsec on management and infrastructure network.
...
before sending on management or infrastructure network, if there is some
sensitive data transferring
